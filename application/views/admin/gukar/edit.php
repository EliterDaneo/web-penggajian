          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select name="jabatan" id="" class="form-control">
                <option value="<?= $e->jabatan ?>" selected> <?= $e->jabatan ?> </option>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select name="golongan" id="" class="form-control">
                <option value="<?= $e->golongan ?>" selected> <?= $e->golongan ?> </option>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select name="jabatan_wali_kelas" id="" class="form-control">
                <option value="<?= $e->jabatan_wali_kelas ?>" selected> <?= $e->jabatan_wali_kelas ?> </option>
                <?php foreach ($jabatan as $j) : ?>
                <option value="<?= $j->nama_jabatan ?>"><?= $j->nama_jabatan ?></option>
                <?php endforeach; ?>
              </select>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select name="jabatan_guru_ekstra" id="" class="form-control">
                <option value="<?= $e->jabatan_guru_ekstra ?>" selected> <?= $e->jabatan_guru_ekstra ?> </option>
                <?php foreach ($jabatan as $j) : ?>
                <option value="<?= $j->nama_jabatan ?>"><?= $j->nama_jabatan ?></option>
                <?php endforeach; ?>
              </select>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <select name="jenis_kelamin" id="" class="form-control">
                <option value=" <?= $e->jenis_kelamin ?>" selected> <?= $e->jenis_kelamin ?> </option>
