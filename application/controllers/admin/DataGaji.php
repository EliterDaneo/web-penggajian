...
class DataGaji extends CI_Controller
{
  ...
  public function ExportExcel()
  {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('Q1', 'Aspirasi');
    $objPHPExcel->getActiveSheet()->setCellValue('R1', 'Potongan BPJS');
    $objPHPExcel->getActiveSheet()->setCellValue('S1', 'Potongan DPLK');
    $objPHPExcel->getActiveSheet()->setCellValue('T1', 'Potongan Angsuran Bank');
    $objPHPExcel->getActiveSheet()->setCellValue('U1', 'Potongan Angsuran Koperasi Gukar');
    $objPHPExcel->getActiveSheet()->setCellValue('V1', 'Potongan Simpanan Koperasi Gukar');
    $objPHPExcel->getActiveSheet()->setCellValue('W1', 'Potongan Belanja Koperasi Gukar');
    $objPHPExcel->getActiveSheet()->setCellValue('X1', 'Potongan Iuran Wajib Muhammadiyah');
    $objPHPExcel->getActiveSheet()->setCellValue('Y1', 'Potongan Bon Sekolah');
    $objPHPExcel->getActiveSheet()->setCellValue('Z1', 'Potongan Bon Koperasi Gukar');
    $objPHPExcel->getActiveSheet()->setCellValue('AA1', 'Potongan Sosial');
    $objPHPExcel->getActiveSheet()->setCellValue('AB1', 'Potongan Angsuran Bank Mini');
    $objPHPExcel->getActiveSheet()->setCellValue('AC1', 'Potongan Tabungan Bingkisan');
    $objPHPExcel->getActiveSheet()->setCellValue('AD1', 'Potongan Infaq Bulanan');
    $objPHPExcel->getActiveSheet()->setCellValue('AE1', 'Potongan Infaq Qurban');
    $objPHPExcel->getActiveSheet()->setCellValue('AF1', 'Potongan Tabungan Qurban');
    $objPHPExcel->getActiveSheet()->setCellValue('AG1', 'Potongan Belanja Wajib Koperasi');
    $objPHPExcel->getActiveSheet()->setCellValue('AH1', 'Potongan Belanja Wajib BC');
    $objPHPExcel->getActiveSheet()->setCellValue('AI1', 'Total Potongan');
    $objPHPExcel->getActiveSheet()->setCellValue('AJ1', 'Total Terima');
    $objPHPExcel->getActiveSheet()->setCellValue('AK1', 'No Rekening');
    ...
    foreach ($data['cetak_gaji'] as $gaji) {
      ...
      $objPHPExcel->getActiveSheet()->setCellValue('Q' . $row, $gaji->aspirasi * 10000);
      $objPHPExcel->getActiveSheet()->setCellValue('R' . $row, $gaji->bpjs_kesehatan);
      $objPHPExcel->getActiveSheet()->setCellValue('S' . $row, $gaji->dplk);
      $objPHPExcel->getActiveSheet()->setCellValue('T' . $row, $gaji->angsuran_bank);
      $objPHPExcel->getActiveSheet()->setCellValue('U' . $row, $gaji->angsuran_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('V' . $row, $gaji->simpanan_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('W' . $row, $gaji->belanja_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('X' . $row, $gaji->iuran_anggota_muhammadiyah);
      $objPHPExcel->getActiveSheet()->setCellValue('Y' . $row, $gaji->bon_sekolah);
      $objPHPExcel->getActiveSheet()->setCellValue('Z' . $row, $gaji->bon_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('AA' . $row, $gaji->sosial);
      $objPHPExcel->getActiveSheet()->setCellValue('AB' . $row, $gaji->angsuran_bank_mini);
      $objPHPExcel->getActiveSheet()->setCellValue('AC' . $row, $gaji->infaq_bulanan);
      $objPHPExcel->getActiveSheet()->setCellValue('AD' . $row, $gaji->infaq_qurban);
      $objPHPExcel->getActiveSheet()->setCellValue('AE' . $row, $gaji->tabungan_bingkisan);
      $objPHPExcel->getActiveSheet()->setCellValue('AF' . $row, $gaji->tabungan_kurban);
      $objPHPExcel->getActiveSheet()->setCellValue('AG' . $row, $gaji->belanja_wajib_koperasi);
      $objPHPExcel->getActiveSheet()->setCellValue('AH' . $row, $gaji->belanja_wajib_bc);
      $objPHPExcel->getActiveSheet()->setCellValue('AI' . $row, $gaji->tabungan_kurban + $gaji->bpjs_kesehatan + $gaji->dplk + $gaji->angsuran_bank + $gaji->angsuran_koperasi_gukar + $gaji->simpanan_koperasi_gukar + $gaji->belanja_koperasi_gukar + $gaji->iuran_anggota_muhammadiyah + $gaji->bon_sekolah + $gaji->bon_koperasi_gukar + $gaji->sosial + $gaji->angsuran_bank_mini + $gaji->tabungan_bingkisan + $gaji->infaq_bulanan + $gaji->infaq_qurban);
      $objPHPExcel->getActiveSheet()->setCellValue('AJ' . $row, ($gaji->tunjangan_anak + $gaji->tunjangan_pangan + $gaji->tunjangan_golongan + $gaji->tunjangan_jabatan + $gaji->tunjangan_walikelas + $gaji->tunjangan_ekstra + $gaji->tunjangan_kehadiran) + ($gaji->kelebihan_jam * 25000) + ($gaji->tmt * 50000) + ($gaji->aspirasi * 50000) - ($gaji->tabungan_kurban + $gaji->bpjs_kesehatan + $gaji->dplk + $gaji->angsuran_bank + $gaji->angsuran_koperasi_gukar + $gaji->simpanan_koperasi_gukar + $gaji->belanja_koperasi_gukar + $gaji->iuran_anggota_muhammadiyah + $gaji->bon_sekolah + $gaji->bon_koperasi_gukar + $gaji->sosial + $gaji->angsuran_bank_mini + $gaji->tabungan_bingkisan + $gaji->infaq_bulanan + $gaji->infaq_qurban + $gaji->belanja_wajib_koperasi + $gaji->belanja_wajib_bc));
      $objPHPExcel->getActiveSheet()->setCellValue('AK' . $row, $gaji->no_rekening);
