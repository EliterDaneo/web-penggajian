...
class LaporanGaji extends CI_Controller
{
  ...
  public function CetakSlipGaji()
  {
    ...
    $data = [
      ...
      'cetak_slip_gaji' => $this->db->query("SELECT 
        tbl_pegawai.nbm, tbl_pegawai.nama_pegawai, tbl_pegawai.jenis_kelamin, tbl_jabatan.nama_jabatan, tbl_jabatan.tunjangan_jabatan, tbl_golongan.nama_golongan, tbl_golongan.tunjangan_golongan, tbl_transport.tunjangan_kehadiran, tbl_transport.jumlah_potongan, tbl_transport.total_tunjangan, tbl_ekstra.nama_ekstra, tbl_ekstra.tunjangan_ekstra, tbl_walikelas.tunjangan_walikelas,tbl_walikelas.tunjangan_walikelas, tbl_pegawai.jabatan_wali_kelas, tbl_pegawai.jabatan_guru_ekstra, tbl_pegawai.no_rekening, tbl_transport.bpjs_kesehatan, tbl_transport.dplk, tbl_transport.angsuran_bank, tbl_transport.angsuran_koperasi_gukar, tbl_transport.simpanan_koperasi_gukar, tbl_transport.belanja_koperasi_gukar, tbl_transport.iuran_anggota_muhammadiyah, tbl_transport.bon_sekolah, tbl_transport.bon_koperasi_gukar, tbl_transport.sosial, tbl_transport.angsuran_bank_mini, tbl_transport.tabungan_bingkisan, tbl_transport.infaq_bulanan, tbl_transport.infaq_qurban, tbl_transport.tabungan_kurban, tbl_transport.tunjangan_anak, tbl_transport.tunjangan_pangan, tbl_pegawai.kelebihan_jam, tbl_transport.bulan
        FROM tbl_pegawai
  ...
  public function ExportLaporanGaji()
  {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('E1', 'TJ. Golongan');
    $objPHPExcel->getActiveSheet()->setCellValue('F1', 'TJ. Jabatan');
    $objPHPExcel->getActiveSheet()->setCellValue('G1', 'TJ. Jabatan Wali Kelas');
    $objPHPExcel->getActiveSheet()->setCellValue('H1', 'TJ. Jabatan Guru Ekstra');
    $objPHPExcel->getActiveSheet()->setCellValue('I1', 'BPJS');
    $objPHPExcel->getActiveSheet()->setCellValue('J1', 'DPLK');
    $objPHPExcel->getActiveSheet()->setCellValue('K1', 'A. Bank');
    $objPHPExcel->getActiveSheet()->setCellValue('L1', 'A. Koperasi Gukar');
    $objPHPExcel->getActiveSheet()->setCellValue('M1', 'S. Koperasi Gukar');
    $objPHPExcel->getActiveSheet()->setCellValue('N1', 'B. Koperasi Gukar');
    $objPHPExcel->getActiveSheet()->setCellValue('O1', 'I. Anggota Muhammadiyah');
    $objPHPExcel->getActiveSheet()->setCellValue('P1', 'Bon Sekolah');
    $objPHPExcel->getActiveSheet()->setCellValue('Q1', 'Bon Koperasi');
    $objPHPExcel->getActiveSheet()->setCellValue('R1', 'Sosial');
    $objPHPExcel->getActiveSheet()->setCellValue('S1', 'A. Bank Mini');
    $objPHPExcel->getActiveSheet()->setCellValue('T1', 'T. Bingkisan');
    $objPHPExcel->getActiveSheet()->setCellValue('U1', 'Infaq Bulanan');
    $objPHPExcel->getActiveSheet()->setCellValue('V1', 'Infaq Qurban');
    $objPHPExcel->getActiveSheet()->setCellValue('W1', 'Tunjangan Anak');
    $objPHPExcel->getActiveSheet()->setCellValue('X1', 'Tunjangan Pangan');
    $objPHPExcel->getActiveSheet()->setCellValue('Y1', 'Kelebihan Jam');
    $objPHPExcel->getActiveSheet()->setCellValue('Z1', 'Tunjangan Transportasi');
    $objPHPExcel->getActiveSheet()->setCellValue('AA1', 'Total Tunjangan');
    $objPHPExcel->getActiveSheet()->setCellValue('AB1', 'Total Potongan');
    $objPHPExcel->getActiveSheet()->setCellValue('AC1', 'Total Diterima');
    ...
    foreach ($data['cetak_gaji'] as $gaji) {
      ...
      $objPHPExcel->getActiveSheet()->setCellValue('F' . $row, $gaji->tunjangan_jabatan);
      $objPHPExcel->getActiveSheet()->setCellValue('G' . $row, $gaji->tunjangan_walikelas);
      $objPHPExcel->getActiveSheet()->setCellValue('H' . $row, $gaji->tunjangan_ekstra);
      $objPHPExcel->getActiveSheet()->setCellValue('I' . $row, $gaji->bpjs_kesehatan);
      $objPHPExcel->getActiveSheet()->setCellValue('J' . $row, $gaji->dplk);
      $objPHPExcel->getActiveSheet()->setCellValue('K' . $row, $gaji->angsuran_bank);
      $objPHPExcel->getActiveSheet()->setCellValue('L' . $row, $gaji->angsuran_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('M' . $row, $gaji->simpanan_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('N' . $row, $gaji->belanja_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('O' . $row, $gaji->iuran_anggota_muhammadiyah);
      $objPHPExcel->getActiveSheet()->setCellValue('P' . $row, $gaji->bon_sekolah);
      $objPHPExcel->getActiveSheet()->setCellValue('Q' . $row, $gaji->bon_koperasi_gukar);
      $objPHPExcel->getActiveSheet()->setCellValue('R' . $row, $gaji->sosial);
      $objPHPExcel->getActiveSheet()->setCellValue('S' . $row, $gaji->angsuran_bank_mini);
      $objPHPExcel->getActiveSheet()->setCellValue('T' . $row, $gaji->tabungan_bingkisan);
      $objPHPExcel->getActiveSheet()->setCellValue('U' . $row, $gaji->infaq_bulanan);
      $objPHPExcel->getActiveSheet()->setCellValue('V' . $row, $gaji->infaq_qurban);
      $objPHPExcel->getActiveSheet()->setCellValue('W' . $row, $gaji->tabungan_kurban);
      $objPHPExcel->getActiveSheet()->setCellValue('X' . $row, $gaji->tunjangan_anak);
      $objPHPExcel->getActiveSheet()->setCellValue('Y' . $row, $gaji->tunjangan_pangan);
      $objPHPExcel->getActiveSheet()->setCellValue('Z' . $row, $gaji->kelebihan_jam * 25000);
      $objPHPExcel->getActiveSheet()->setCellValue('AA' . $row, $gaji->tunjangan_kehadiran);
      $objPHPExcel->getActiveSheet()->setCellValue('AB' . $row, $gaji->tunjangan_golongan + $gaji->tunjangan_jabatan + $gaji->tunjangan_walikelas + $gaji->tunjangan_ekstra + $gaji->tunjangan_kehadiran + $gaji->tunjangan_anak + $gaji->tunjangan_pangan + ($gaji->kelebihan_jam * 25000));
    ...
    header('Content-Disposition: attachment;filename="LaporanGaji.xlsx"');
