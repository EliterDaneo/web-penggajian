...
class LaporanGaji extends CI_Controller
{
  ...
  public function ExportExcel()
  {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('P1', 'Kelebihan Jam');
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('W1', 'Potongan Iuran Kemuhammadiyahan');
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('AF1', 'Total Potongan');
    $objPHPExcel->getActiveSheet()->setCellValue('AG1', 'Total Tunjangan');
    $objPHPExcel->getActiveSheet()->setCellValue('AH1', 'Total Terima');
    ...
    foreach ($data['cetak_gaji'] as $gaji) {
      ...
      $objPHPExcel->getActiveSheet()->setCellValue('AB' . $row, $gaji->tabungan_bingkisan);
      ...
      $objPHPExcel->getActiveSheet()->setCellValue('AF' . $row, $gaji->tabungan_kurban + $gaji->bpjs_kesehatan + $gaji->dplk + $gaji->angsuran_bank + $gaji->angsuran_koperasi_gukar + $gaji->simpanan_koperasi_gukar + $gaji->belanja_koperasi_gukar + $gaji->iuran_anggota_muhammadiyah + $gaji->bon_sekolah + $gaji->bon_koperasi_gukar + $gaji->sosial + $gaji->angsuran_bank_mini + $gaji->tabungan_bingkisan + $gaji->infaq_bulanan + $gaji->infaq_qurban);
      $objPHPExcel->getActiveSheet()->setCellValue('AG' . $row, ($gaji->tunjangan_anak + $gaji->tunjangan_pangan + $gaji->tunjangan_jabatan + $gaji->tunjangan_walikelas + $gaji->tunjangan_ekstra + $gaji->tunjangan_pasangan));
      $objPHPExcel->getActiveSheet()->setCellValue('AH' . $row, ($gaji->tunjangan_anak + $gaji->tunjangan_pangan + $gaji->tunjangan_golongan + $gaji->tunjangan_jabatan + $gaji->tunjangan_walikelas + $gaji->tunjangan_ekstra + $gaji->tunjangan_kehadiran + $gaji->tunjangan_pasangan) + ($gaji->kelebihan_jam * 25000) + ($gaji->tmt * 50000) - ($gaji->tabungan_kurban + $gaji->bpjs_kesehatan + $gaji->dplk + $gaji->angsuran_bank + $gaji->angsuran_koperasi_gukar + $gaji->simpanan_koperasi_gukar + $gaji->belanja_koperasi_gukar + $gaji->iuran_anggota_muhammadiyah + $gaji->bon_sekolah + $gaji->bon_koperasi_gukar + $gaji->sosial + $gaji->angsuran_bank_mini + $gaji->tabungan_bingkisan + $gaji->infaq_bulanan + $gaji->infaq_qurban));
